// Dynamic brand SVG keeps the cloud colors aligned with the current accent.

import 'package:flutter/material.dart';

String buildAppBrandLogoSvg(Color accent) {
...
<svg width="240" height="80" viewBox="0 0 240 80" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="g1" x1="20" y1="10" x2="90" y2="70">
  ...
  <text x="104" y="49" font-family="Inter, PingFang SC, Microsoft YaHei, sans-serif" font-size="34" font-weight="700" fill="#1E293B">云卷</text>
  <text x="104" y="66" font-family="Inter, PingFang SC, Microsoft YaHei, sans-serif" font-size="11" fill="#64748B">Local Manager for Remote Volumes</text>
</svg>
''';
}
