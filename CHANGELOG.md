...
## Unreleased
- Windows exit: confirmed window exit and tray-menu Exit now clean active mounts before destroying the app window, so Cloud Files providers disconnect and deregister during normal shutdown.
