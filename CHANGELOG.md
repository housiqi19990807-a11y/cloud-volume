...
## Unreleased
- Windows window chrome: the borderless host now retains the standard overlapped-window contract and uses native maximize/restore system commands, preserving DWM transitions and taskbar work-area behavior without a white repaint fallback.
