...
- File manager now uses a Finder-style title bar with back/forward history, expandable breadcrumbs, in-place folder creation, and `..` parent entries in non-root directories.
