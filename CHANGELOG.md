...
## Unreleased
- Windows window chrome: maximize now respects the active monitor work area so the taskbar remains visible, and the Flutter surface is redrawn immediately after resize to avoid a transient black frame.
