...
- The bucket browser now separates these interactions by layout: list mode keeps the fixed header row plus visible mount actions, while grid mode shows only the bucket icon and name and moves mount/open/unmount actions into the right-click menu.
