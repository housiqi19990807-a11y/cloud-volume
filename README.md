...
- File browsing now uses a Finder-style top bar with back/forward navigation, a clickable folder title that expands breadcrumbs, and in-place folder creation plus `..` entries in non-root directories.
